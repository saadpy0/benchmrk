    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-zinc-400 mt-1">Here's how you're doing</p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
            ...
            <p className="text-2xl font-bold">₹{parseFloat(wallet?.totalEarned || 0).toFixed(2)}</p>
          </div>
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
        ...
        {profile?.kycStatus !== 'VERIFIED' && (
          <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-4 mb-8 flex items-center justify-between">
            <div>
              <p className="text-yellow-400 font-medium">Complete your KYC</p>
              <p className="text-zinc-400 text-sm">You need to verify your identity before requesting payouts</p>
            </div>
            <button
        ...
        <div>
          ...
          {applications.length === 0 ? (
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-8 text-center">
              <p className="text-zinc-400 mb-4">You haven't applied to any campaigns yet</p>
              <button
                onClick={() => router.push('/discover')}
                className="bg-white text-black font-semibold px-6 py-2 rounded-lg hover:bg-zinc-200 transition"
              >
                Discover Campaigns
              </button>
            </div>
              ...
              {applications.map((app: any) => (
                <div key={app.id} className="bg-zinc-900 border border-zinc-800 rounded-xl p-5 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-zinc-400 text-sm">₹{app.campaign.cpvRate} per view</p>
                  </div>
